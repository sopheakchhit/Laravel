...
<div class="container">
  <div class="row">
  	<div class="col-md-12 col-md-offset-0">
			...
			<i class="fa fa-fw fa fa-user"></i>	Name  : <h3><?php echo e($user->name); ?></h3> <br> 
			<i class="fa fa-fw fa fa-envelope"></i> Email : <h3><?php echo e($user->email); ?></h3> <br>
			<i class="fa fa-fw fa fa-institution"></i> Address : <h3><?php echo e($user->address); ?></h3> <br>
			<i class="fa fa-fw fa fa-phone-square"></i> Phone Number : <h3><?php echo e($user->phone); ?></h3><br><hr>

		       <form action="<?php echo e(action('UserController@destroy', $user['id'])); ?>" method="post" style="margin-right: 20px;">
		                    <?php echo e(csrf_field()); ?>

		                    <input name="_method" type="hidden" value="DELETE">
		                    <button class="btn btn-danger " type="submit" 
		                    onclick="return confirm('Are sure for DELETE this Product?')" >
		                    Delete <i class="fa fa-fw fa fa-trash" style="font-size: 18px;"></i> </button>
		        </form >
