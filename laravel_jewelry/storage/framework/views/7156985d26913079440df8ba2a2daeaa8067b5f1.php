...
<?php $__env->startSection('content'); ?>
	...
	<nav class="navbar navbar" style="padding-left: 200px;">
     ...
     <div class="navbar-header">
      <a class="navbar-brand" href="<?php echo e(url('frontend')); ?>">HOME</a>
     </div>
  ...
  <div class="container">
      ...
      <div class="panel panel-primary">
      	...
      	<div class="panel panel-body">
      		...
      		<div class="col-sm-5">
      			<img src="<?php echo e(asset('assets/img/hdr.png')); ?>" width="100" height="100">
      			<img src="<?php echo e(asset('assets/img/hrg.png')); ?>" width="100" height="100">
      			<img src="<?php echo e(asset('assets/img/hde.png')); ?>" width="100" height="100">
      			<img src="<?php echo e(asset('assets/img/hng.png')); ?>" width="100" height="100">
      			<img src="<?php echo e(asset('assets/img/heg.png')); ?>" width="100" height="100">
      			<img src="<?php echo e(asset('assets/img/hdn.png')); ?>" width="100" height="100">
      			<img src="<?php echo e(asset('assets/img/hsr.png')); ?>" width="100" height="100">
      			<img src="<?php echo e(asset('assets/img/hse.png')); ?>" width="100" height="100">
      		</div>
      	</div>
      </div>
      </div>
