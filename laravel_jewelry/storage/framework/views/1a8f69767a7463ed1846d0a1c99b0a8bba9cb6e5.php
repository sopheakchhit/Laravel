...
<content><?php echo $__env->yieldContent('content'); ?></content>
    ...
    <!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
        <div class="collapse navbar-collapse navbar-ex1-collapse ">
            <ul class="nav navbar-nav side-nav" style="background-color:black; margin-top: 2px;">
             ...
             <li>
            <a href="<?php echo e(url('admin')); ?>" style="color: white;"><i class="fa fa-fw fa-home"> </i> HOME</a>
            </li>

             <li>
                <a href="<?php echo e(url('admin/product')); ?>" style="color: white;"><i class="fa fa-fw fa-pinterest-p"> </i> PRODUCTS</a>
            </li>

            <li>
                <a href="<?php echo e(url('admin/user')); ?>"" style="color: white;"><i class="fa fa-fw fa-user"> </i> USER</a>
            </li>

             <li>
            <a href="<?php echo e(url('admin/categoires')); ?>" style="color: white;"><i class="fa fa-fw fa-list"> </i> CATEGORIES</a>
            </li>

            <li>
                <a href="<?php echo e(url('admin/order')); ?>" style="color: white;">
                    <i class="fa fa-fw fa fa-file-text"> </i> ORDERS</a>
            </li>

            <li>
                <a href="<?php echo e(url('admin/chart2')); ?>" style="color: white;">
                <i class="fa fa-bar-chart"> </i> REPORTS AND FORECASTING</a>
            </li>

             <li>
                <a href="<?php echo e(url('admin/sendback')); ?>" style="color: white;">
                    <i class="fa fa-fw fa fa-envelope-o"> </i> SENDBACK</a>
            </li>


            <li>
                <a href="<?php echo e(url('admin/feedbackAdmin')); ?>" style="color: white;">
                <i class="fa fa-fw fa fa-edit"> </i> FEEDBACK</a>
            </li>

            <!-- <li>
                <a href="<?php echo e(url('admin/slider')); ?>" style="color: white;">
